...
%         hold on; plot([seg(i,1)-xSize/2 seg(i,2)+xSize/2],[min(ylim)+0.001 min(ylim)+0.001],'k','LineWidth',3);
%         hold on; plot([seg(i,1)-xSize seg(i,2)+xSize], [min(ylim)+0.00001 min(ylim)+0.00001],'k','LineWidth',3);
    end
end
