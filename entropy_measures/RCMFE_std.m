function Out_RCMFE = RCMFE_std(x,m,r,n,tau,Scale)
%
%  This function calculates the refined composite multiscale fuzzy entropy (RCMFE) whose coarse-graining uses standard deviation (RCMFE_std)
%
%
% Inputs:
%
