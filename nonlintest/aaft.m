% Generates surrogate data for a given time series 'xV' using the amplitude adjusted Fourier transform (AAFT)
% 
% Usage:
%       [zV] = aaft(xV, nsur)
% 
...
% 
% REF: Kugiumtzis, "Surrogate data test for nonlinearity including monotonic transformations," 
% Phys. Rev. E, vol. 62, no. 1, 2000. 
