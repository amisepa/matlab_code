% my_connplot() - plot circle or brain image showing EEG connectivity 
%   between brain regions (source-reconstructed data)
%
% Usage:
%     my_connplot(array, 'key', val);
%
% Input:
...
if ~strcmpi(g.brainimg, 'off')
    ...
    for iX = 1:length(x)
        ...
        plot(x(iX),y(iX),'.','markersize', 14, 'color', col);
    end
end
